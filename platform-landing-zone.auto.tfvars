...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "martijn.dekkers@varoenergy.com"

    # Resource group names
    management_resource_group_name               = "rg-management-$${starter_location_01}"
    connectivity_hub_primary_resource_group_name = "rg-hub-$${starter_location_01}"
    dns_resource_group_name                      = "rg-hub-dns-$${starter_location_01}"
    # ddos_resource_group_name                     = "rg-hub-ddos-$${starter_location_01}" # ! Disabled in this configuration
    asc_export_resource_group_name = "rg-asc-export-$${starter_location_01}"

    # Resource names management
    log_analytics_workspace_name = "law-management-$${starter_location_01}"
    # ddos_protection_plan_name               = "ddos-$${starter_location_01}" # ! Disabled in this configuration
    ...
    primary_hub_address_space                          = "10.246.100.0/24"
    primary_hub_virtual_network_address_space          = "10.246.100.0/24"
    primary_firewall_subnet_address_prefix             = "10.246.100.0/26"
    primary_bastion_subnet_address_prefix              = "10.246.100.64/26"
    primary_gateway_subnet_address_prefix              = "10.246.100.128/27"
    primary_private_dns_resolver_subnet_address_prefix = "10.246.100.160/28"
  }
  /* 
  ...
  */
  resource_group_identifiers = {
    ...
    # ddos_protection_plan_resource_group_id = "/subscriptions/$${subscription_id_connectivity}/resourcegroups/$${ddos_resource_group_name}" # ! Disabled in this configuration
  }
  /* 
  ...
  */
  resource_identifiers = {
    ...
    # ddos_protection_plan_id                     = "$${ddos_protection_plan_resource_group_id}/providers/Microsoft.Network/ddosProtectionPlans/$${ddos_protection_plan_name}" # ! Disabled in this configuration
  }
}
      ...
      policy_assignments = {
        ...
        Deploy-MDFC-Config-H224 = {
          parameters = {
            ...
            emailSecurityContact                        = "martijn.dekkers@varoenergy.com"
